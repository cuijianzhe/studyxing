"""
Django settings for studyxing project.
...
WSGI_APPLICATION = 'studyxing.wsgi.application'
...
# celery configs
CELERY_BROKER_URL = os.getenv('CELERY_BROKER_URL', 'amqp://cuijianzhe:598941324@192.168.51.207:5672/wenyang')
